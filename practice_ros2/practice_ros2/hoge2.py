...
class Hoge2(Node):
    def __init__(self):
        ...
        self.sub = self.create_subscription(CoordinateXY, 'hoge', self._sub_callback, 10)
        self.pub = self.create_publisher(Point, 'hoge2', 10)
        self.pub2 = self.create_publisher(Point, 'hoge3', 10)
